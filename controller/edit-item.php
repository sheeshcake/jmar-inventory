<?php
    ...
    if(isset($_POST["submit"])){
        ...
        $price_per_package = floatval($item_capital / )
        $item_price = number_format(floatval(floatval($item_capital) + floatval(floatval($item_capital) * floatval(floatval($item_tax) / 100))));
