<?php
    ...
    if(isset($_POST["submit"])){
        ...
        if(mysqli_num_rows($result) == 0){
            ...
            $sql = "INSERT INTO items (item_img, item_name, item_brand, item_desc, item_unit, item_unit_package, item_price, item_tax, item_capital, item_unit_divisor, item_stock, item_added, category_id, supplier_id,  item_stock_warehouse) VALUES (
                '$item_img', '$item_name', '$item_brand', '$item_desc', '$item_unit', '$item_unit_package', '$item_price', '$item_tax', '$item_capital', '$item_unit_divisor', '$item_stock', '$item_added', '$category_id', '$supplier_id', '$item_stock_warehouse')";
